"""Evaluation entrypoint for periodic 2D FitzHugh-Nagumo latent VAE checkpoints."""
...
try:
    ...
    from grad_flow_l2.fhn2d.eval import (
        _evaluate_rollout_curves,
        _parse_snapshot_times,
        _plot_curve,
        _plot_samples,
    ...
    from grad_flow_l2.fhn2d.train_vae import _build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate periodic 2D FitzHugh-Nagumo latent VAE checkpoint")
    parser.add_argument("--dataset-path", type=str, required=True)
    parser.add_argument("--checkpoint", type=str, required=True)
    parser.add_argument("--split", type=str, default="test", choices=["train", "val", "test"])
    parser.add_argument("--output-dir", type=str, default="grad_flow_l2/fhn2d/outputs_vae/eval")
