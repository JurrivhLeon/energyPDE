"""
Evaluate and visualize deterministic latent FNO Markov baselines on unforced 1D KS data.
"""
...
try:
    ...
    from grad_flow_l2.ks1d.train import _build_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate deterministic latent FNO Markov baseline on 1D KS")
    parser.add_argument(
        "--dataset-path",
        type=str,
    ...
    parser.add_argument("--output-dir", type=str, default="grad_flow_l2/ks1d/outputs_sv/eval")
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Compatibility flag; KS deterministic evaluation always disables the forcing channel.",
    )
...
def _plot_samples(
    ...
    for sample_id in sample_ids:
        ...
        fig.suptitle(
            f"KS sample {sample_id}: mean rel L2={rel_mean_i:.3e}, final rel L2={rel_final_i:.3e}",
            fontsize=13,
        )
