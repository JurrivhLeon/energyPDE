"""Training entrypoint for periodic 2D compressible NS latent Markov models."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train latent Markov model on periodic 2D compressible NS data")
