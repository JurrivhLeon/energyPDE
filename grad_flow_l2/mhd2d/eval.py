"""Evaluation entrypoint for periodic 2D MHD hidden-space checkpoints."""
...
try:
    ...
    from grad_flow_l2.mhd2d.train import _build_model   # uses latent_markov_mc
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate periodic 2D MHD hidden-space checkpoint")
    parser.add_argument("--dataset-path",    type=str, required=True)
    parser.add_argument("--checkpoint-path", type=str, required=True)
    parser.add_argument("--split",           type=str, default="val", choices=["train", "val", "test"])
    parser.add_argument("--output-dir",      type=str, default="grad_flow_l2/mhd2d/outputs/eval")
